"""
Django settings for e_Education project.
...
SECRET_KEY = 'g%(imv2ux2z-yu81bdesu!i*yv52hasd32=b=w5n^mfqq4$4h8'
...
try:
    from online_learning_platform.local_settings import *
except ImportError:
    pass
